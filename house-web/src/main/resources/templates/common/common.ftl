                        ...
                        <div class="col-md-3 col-sm-3">
                            <article>
                                ...
                                <ul class="list-unstyled list-links">
                                    <li><a href="/user/index">搜索房产</a></li>
                                    <li><a href="/user/Register">登录/注册</a></li>
            ...
            <div class="container">
                ...
                <div class="user-area">
                    ...
                    <#if (loginUser.userName)??>
                        <a href="/user/profile" class="promoted">Hello,${(loginUser.userName)!}</a>
                          <#if (loginUser.email)?? && (loginUser.email) == "2771109447@qq.com">
                          <a href="/agency/create" class="promoted">创建经纪机构</a>
                          </#if>
                        <a href="/user/logout" class="promoted">退出</a>
                    <#else>
                        <a href="/user/Register" class="promoted"><strong>注册</strong></a>
            ...
            <header class="navbar" id="top" role="banner">
                <div class="navbar-header">
                    ...
                    <div class="navbar-brand nav" id="brand">
                        <a href="/house/index"><img src="/static/assets/img/logo.png" alt="brand"></a>
                    </div>
                </div>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="has-child"><a href="#">经纪人</a>
                            <ul class="child-navigation">
                                ...
                                <li><a href="/agency/agencyList">经纪机构列表</a></li>
                            </ul>
                        </li>
